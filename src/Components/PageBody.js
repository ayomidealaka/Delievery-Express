...
import asset1 from './White BG Removed/drawkit-transport-scene-6.svg';
...
const PageBody = () => {
  ...
  return (
    <div className={style.PageBody}>
                  ...
                  <g id="TRUCK-2" data-name="TRUCK">
                    ...
                    <g id="CABIN">
                      ...
                      <path
                        ...
                        fill="#59221d"
                      />
                      <circle cx="231.83" cy="1414.8" r="5.08" fill="#ffc200" />
                      <circle cx="103.78" cy="1414.8" r="5.08" fill="#ffc200" />
                      <circle cx="135.79" cy="1414.8" r="5.08" fill="#ffc200" />
                      <circle cx="167.81" cy="1414.8" r="5.08" fill="#ffc200" />
                      <circle cx="199.82" cy="1414.8" r="5.08" fill="#ffc200" />
                      <circle
                        cx="215.83"
                        cy="1431.32"
                        r="5.08"
                      ...
                      <circle
                        ...
                        fill="#ffc200"
                      />
                      <circle cx="151.8" cy="1431.32" r="5.08" fill="#ffc200" />
                      <circle
                        cx="183.81"
                        cy="1431.32"
                        r="5.08"
                      ...
                      <circle
                        ...
                        fill="#ffc200"
                      />
                      <circle cx="151.8" cy="1464.37" r="5.08" fill="#ffc200" />
                      <circle
                        cx="183.81"
                        cy="1464.37"
                        r="5.08"
                      ...
                      <circle
                        ...
                        fill="#ffc200"
                      />
                      <circle cx="151.8" cy="1497.42" r="5.08" fill="#ffc200" />
                      <circle
                        cx="183.81"
                        cy="1497.42"
                        r="5.08"
                      ...
                      <circle
                        ...
                        fill="#ffc200"
                      />
                      <circle cx="151.8" cy="1530.46" r="5.08" fill="#ffc200" />
                      <circle
                        cx="183.81"
                        cy="1530.46"
                        r="5.08"
                      ...
                      <circle
                        ...
                        fill="#ffc200"
                      />
                      <circle cx="151.8" cy="1563.51" r="5.08" fill="#ffc200" />
                      <circle
                        cx="183.81"
                        cy="1563.51"
                        r="5.08"
                ...
                <g id="_1_MAN" data-name="1 MAN">
                  ...
                  <g id="BOXES-2" data-name="BOXES">
                    ...
                    <rect
                      ...
                      stroke-width="5"
                    />
                    <circle cx="2291.2" cy="1829.02" r="5.24" fill="#ffc200" />
                    <circle cx="2258.17" cy="1829.02" r="5.24" fill="#ffc200" />
                    <circle cx="2324.22" cy="1829.02" r="5.24" fill="#ffc200" />
                    <circle cx="2225.15" cy="1829.02" r="5.24" fill="#ffc200" />
                    <circle cx="2274.69" cy="1846.24" r="5.24" fill="#ffc200" />
                    <circle cx="2241.66" cy="1846.24" r="5.24" fill="#ffc200" />
                    <circle cx="2307.71" cy="1846.24" r="5.24" fill="#ffc200" />
                    <circle cx="2291.2" cy="1863.45" r="5.24" fill="#ffc200" />
                    <circle cx="2258.17" cy="1863.45" r="5.24" fill="#ffc200" />
                    <circle cx="2324.22" cy="1863.45" r="5.24" fill="#ffc200" />
                    <circle cx="2225.15" cy="1863.45" r="5.24" fill="#ffc200" />
                    <circle cx="2274.69" cy="1880.67" r="5.24" fill="#ffc200" />
                    <circle cx="2241.66" cy="1880.67" r="5.24" fill="#ffc200" />
                    <circle cx="2307.71" cy="1880.67" r="5.24" fill="#ffc200" />
                    <circle cx="2291.2" cy="1897.88" r="5.24" fill="#ffc200" />
                    <circle cx="2258.17" cy="1897.88" r="5.24" fill="#ffc200" />
                    <circle cx="2324.22" cy="1897.88" r="5.24" fill="#ffc200" />
                    <circle cx="2225.15" cy="1897.88" r="5.24" fill="#ffc200" />
                    <circle cx="2274.69" cy="1915.09" r="5.24" fill="#ffc200" />
                    <circle cx="2241.66" cy="1915.09" r="5.24" fill="#ffc200" />
                    <circle cx="2307.71" cy="1915.09" r="5.24" fill="#ffc200" />
                    <circle cx="2291.2" cy="1932.31" r="5.24" fill="#ffc200" />
                    <circle cx="2258.17" cy="1932.31" r="5.24" fill="#ffc200" />
                    <circle cx="2324.22" cy="1932.31" r="5.24" fill="#ffc200" />
                    <circle cx="2225.15" cy="1932.31" r="5.24" fill="#ffc200" />
                    <circle cx="2274.69" cy="1949.52" r="5.24" fill="#ffc200" />
                    <circle cx="2241.66" cy="1949.52" r="5.24" fill="#ffc200" />
                    <circle cx="2307.71" cy="1949.52" r="5.24" fill="#ffc200" />
                    <circle cx="2291.2" cy="1966.73" r="5.24" fill="#ffc200" />
                    <circle cx="2258.17" cy="1966.73" r="5.24" fill="#ffc200" />
                    <circle cx="2324.22" cy="1966.73" r="5.24" fill="#ffc200" />
                    <circle cx="2225.15" cy="1966.73" r="5.24" fill="#ffc200" />
                    <circle cx="2191.69" cy="1829.02" r="5.24" fill="#ffc200" />
                    <circle cx="2208.2" cy="1846.24" r="5.24" fill="#ffc200" />
                    <circle cx="2191.69" cy="1863.45" r="5.24" fill="#ffc200" />
                    <circle cx="2208.2" cy="1880.67" r="5.24" fill="#ffc200" />
                    <circle cx="2191.69" cy="1897.88" r="5.24" fill="#ffc200" />
                    <circle cx="2208.2" cy="1915.09" r="5.24" fill="#ffc200" />
                    <circle cx="2191.69" cy="1932.31" r="5.24" fill="#ffc200" />
                    <circle cx="2208.2" cy="1949.52" r="5.24" fill="#ffc200" />
                    <circle cx="2191.69" cy="1966.73" r="5.24" fill="#ffc200" />
                    <rect
                      x="2338.95"
                      y="1807.81"
                      width="360.93"
      ...
      <section className={style.section2} ref={myRef}>
        <h1>
          Book a delivery today<span>.</span>
          <BookADeliveryForm />
        </h1>
      </section>
    </div>
